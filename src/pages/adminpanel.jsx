...
export function AdminPanel() {
    ...
    useEffect(() => {
        ...
        const getAllUsers = async () => {
            try {
                const res = await axios.get("https://zoom-backend-l0uq.onrender.com/api/getallUsers.php", {
                    headers: {
        ...
        const getAllPosts = async () => {
            try {
                const res = await axios.get("https://zoom-backend-l0uq.onrender.com/api/getallposts.php", {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
